define (['jquery', 'backbone', 'cart/cart.view', 'cart/cartitem.coll'], function ($, Backbone, CartView, CartColl) {
	return Cart = Backbone.Model.extend({
		defaults: {
			status: 'cart', //Can be 'cart', 'loading', 'order', 'done' and 'success'
			user: window.user,
			activeStep: 0,
			doneStep: 0,
			albumsReady: false,
